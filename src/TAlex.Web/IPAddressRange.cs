...
namespace TAlex.Web
{
    ...
    public class IPAddressRange
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IPAddressRange"/> class by using
        ...
        /// </summary>
        /// <param name="address">An <see cref="IPAddress"/> for check.</param>
        ...
        /// <summary>
        /// Converts an IP addresses range string to an <see cref="IPAddressRange"/> instance.
        /// </summary>
        /// <param name="s">
        /// A string that contains an IP addresses range in dotted-quad notation for IPv4 and
        /// in colon-hexadecimal notation for IPv6.
        /// </param>
        /// <returns>An <see cref="IPAddressRange"/> instance.</returns>
        /// <exception cref="ArgumentException">s contains IP addresses from different families.</exception>
        /// <exception cref="ArgumentNullException">s is null.</exception>
        /// <exception cref="FormatException">s is not a valid IP addresses range.</exception>
        ...
        /// <param name="result">The <see cref="IPAddressRange"/> version of the string.</param>
