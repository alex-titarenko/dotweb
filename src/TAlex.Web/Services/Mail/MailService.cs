...
namespace TAlex.Web.Services.Mail
{
    ...
    public class MailService : IMailService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MailService"/> class by using
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MailService"/> class that sends
        ...
        /// </summary>
        /// <param name="recipients">A <see cref="String"/> that contains the addresses that the message is sent to.</param>
