...
namespace TAlex.Web.Tests
{
    ...
    public class IPAddressRangeTest
    {
        ...
        public void Ctor_AddressesFromDifferentsFamileis()
        {
            ...
            //action
            TestDelegate action = () => new IPAddressRange(lower, upper);
        ...
        public void Parse_ArgumentNullException()
        {
            ...
            //action
            TestDelegate action = () => IPAddressRange.Parse(address);
        ...
        public void Parse_InvalidFormatOfRangeAddresses()
        {
            ...
            //action
            TestDelegate action = () => IPAddressRange.Parse(String.Format("{0}-{1}-{1}", lowerAddress, upperAddress));
