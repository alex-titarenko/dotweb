...
namespace TAlex.AspNetCore.Mvc.UI.Grid
{
	...
	public class GridModel<T> : IGridModel<T> where T : class
    {
        ...
        /// </summary>
        public GridModel(IModelMetadataProvider metadataProvider)
        {
            this.metadataProvider = metadataProvider;
            _emptyText = "There is no data available.";
            Column = CreateColumnBuilder();
        }

        /// <summary>
        /// Column builder for this grid model
        /// </summary>
        public ColumnBuilder<T> Column { get; }
        ...
        /// Section overrides for this grid model.
        /// </summary>
        public GridSections<T> Sections { get; } = new GridSections<T>();
        ...
        {
            return new ColumnBuilder<T>(this.metadataProvider);
        }
    }
}
